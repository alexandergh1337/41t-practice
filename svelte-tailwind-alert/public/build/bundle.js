...
var app = (function () {
	...
	*/
	...
	function create_if_block(ctx) {
		...
		const block = {
			c: function create() {
				...
				add_location(svg, file$1, 99, 8, 2525);
				attr_dev(span, "class", "mr-2");
				add_location(span, file$1, 98, 6, 2497);
			},
	...
	function create_fragment$1(ctx) {
		...
		const block = {
			c: function create() {
				...
				add_location(div2, file$1, 126, 2, 3521);
				...
				add_location(div3, file$1, 89, 0, 2085);
			},
	...
	// (68:4) {#each $notifications as notification (notification.id)}
	function create_each_block(key_1, ctx) {
		...
		dispatch_dev("SvelteRegisterBlock", {
			...
			type: "each",
			source: "(68:4) {#each $notifications as notification (notification.id)}",
			ctx
		});
